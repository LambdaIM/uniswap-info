          ...
          !tokenData.exists ? (
            <LightGreyCard style={{ textAlign: 'center' }}>
              ...
              <StyledExternalLink
                ...
                href={`https://swap.lambda.im/#/add/${formattedAddress}`}
              >
                here.
              </StyledExternalLink>
            </LightGreyCard>
            ...
            <AutoColumn $gap="32px">
              <AutoColumn $gap="32px">
                ...
                <ResponsiveRow align="flex-end">
                  ...
                  {activeNetwork !== EthereumNetworkInfo ? null : (
                    <RowFixed>
                      <StyledExternalLink href={`https://swap.lambda.im/#/add/${formattedAddress}`}>
                      ...
                      <StyledExternalLink href={`https://swap.lambda.im/#/swap?inputCurrency=${formattedAddress}`}>
