...
const LAMBDA_WETH_ADDRESS = '0x4200000000000000000000000000000000000006'

export const WETH_ADDRESSES = [/*WETH_ADDRESS, ARBITRUM_WETH_ADDRESS, */ LAMBDA_WETH_ADDRESS]
...
export const TOKEN_HIDE: { [key: string]: string[] } = {
  ...
  [SupportedNetwork.POLYGON]: [
    // '0x8d52c2d70a7c28a9daac2ff12ad9bfbf041cd318'
  ],
...
export const POOL_HIDE: { [key: string]: string[] } = {
  ...
  [SupportedNetwork.POLYGON]: [
    // '0x5f616541c801e2b9556027076b730e0197974f6a'
  ],
  [SupportedNetwork.ARBITRUM]: [],
  [SupportedNetwork.OPTIMISM]: [],
  [SupportedNetwork.CELO]: [],
...
export const START_BLOCKS: { [key: string]: number } = {
  ...
  [SupportedNetwork.LAMBDA]: 956482,
}
